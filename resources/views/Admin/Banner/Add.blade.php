                              ...
                              <div class="form-group">
                                    <label for="page">Page</label>
                                      <select class="form-control{{ $errors->has('page_name') ? ' is-invalid' : '' }}"  name="page_name" >
                                        ...
                                        <option value="php-test">Php Test</option>
                                        <option value="laravel-test">Laravel Test</option>
                                        <option value="wordpress-test">Wordpress Test</option>
                                        <option value="gk-test">GK Test</option>
