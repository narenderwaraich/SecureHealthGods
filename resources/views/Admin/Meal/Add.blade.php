  ...
  <section class="content-wrapper" style="min-height: 960px;">
    <section class="content-header">
      ...
      <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form action="/admin/meal/create" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                      <div class="box">
                           ...
                           <!--  <bootstrap-alert /> -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="item_name" placeholder="Enter Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sale" placeholder="Enter Sale Price">
                                </div>
